...
import { GetTodayPatient } from "../adminDashboardApi/adminDashboardReducer";
...
function TodayPatientTable({rows}) {
      ...
      },
      {
        ...
        renderCell: (params) => {
          const onClick = async(e) => {
            ...
            await  dispatch(GetTodayPatient())
...
export default TodayPatientTable;
